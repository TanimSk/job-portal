...
const LoginPage = () => {
  ...
  return (
    <section className="bg-gray-50 min-h-screen flex items-center justify-center">
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 overflow-hidden h-[80vh]">
        {/* Left Section - Image */}
        ...
        <div
          className={`${
            clicked ? "translate-y-[-32rem] " : " translate-y-[3rem]"
          }  w-full md:w-1/2 flex flex-col duration-500 px-8 md:px-16`}
        >
          {/* Upload Image */}
          <div className="flex flex-col items-center space-y-3">
            ...
            <div
              onClick={handleClick}
              className="flex mt-10 bg-white p-2 rounded-full hover:scale-105 duration-200 cursor-pointer"
            >
          ...
          <form
            ...
            className="w-full max-w-md mt-[15.9rem]"
          >
            <div className="flex space-x-3 items-center justify-center">
              <h2 className="font-bold whitespace-no-wrap text-2xl text-[#002D74] mb-5">
                Applicant Registration
              </h2>
              <div className="p-2 bg-white hover:scale-105 cursor-pointer rounded-full">
                <IoIosArrowUp onClick={()=>setclicked(false)} className="text-slate-500" size={25} />
              </div>
            </div>
